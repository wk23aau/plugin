...
3.  **Activate the plugin**: Go to WordPress admin > Plugins and activate "Archopinion - AI Architectural Review".

4.  **Configure settings**: Go to Archopinion > Settings and add your Gemini API key.
...
- **HTML Reports**: Simple and printable analysis reports
